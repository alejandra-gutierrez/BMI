function neuron_weights = nonLinReg(training_input, training_output, dir)
...
%     plot(training_input2');
    ...
    beta0 = zeros(5* size(training_input2, 1), 1);

    disp(size(beta0));
    neuron_weights = nlinfit(training_input2, training_output, @nonLinModelFun, beta0);
